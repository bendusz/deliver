...
| `large` | multi-sprint or multi-author | Adds `docs/constitution.md` (`/deliver:constitution`), quality checklists (`/deliver:checklist`), durable verification reports, a traceability table, and `Skeleton: specdd`. |
