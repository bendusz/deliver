#!/usr/bin/env node
// deliver PreToolUse hook: block writes to ANOTHER actor's state files under pm/actors/.
//
...
fs.writeSync(2, `deliver blocked pm/actors/${base}: that is '${target}'s state file and you are '${me}'.
Write your own actor files, or coordinate through pm/pm-state.json and pm/log.md.
