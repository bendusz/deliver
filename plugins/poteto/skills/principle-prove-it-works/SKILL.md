...
Keep the artifact visible for the human. Commit it only for large or complex work where the trail has to be auditable later, like a big port or migration (pstack's upstream `show-me-your-work` skill, not bundled here; under pm-skill the trail is `pm/log.md`). Most work just needs it visible, not committed.
