...
- At project end, with a wiki, run `librarian lint` and give the writer `docs/wiki/index.md`, per
  `knowledge.md`. Then have it produce `docs/completion-report.md` from
