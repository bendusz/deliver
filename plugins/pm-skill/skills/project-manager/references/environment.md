...
PR with the message format in `documentation.md`, and merge it. Never push to a remote without an
explicit request.
...
prompt. When the OpenAI Codex CLI is installed, `/pm-skill:codex-review` can add an independent
