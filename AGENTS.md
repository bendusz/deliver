...
## Layout
- `plugins/deliver/skills/project-manager/`: `SKILL.md` plus the phase and on-demand references.
- `plugins/deliver/agents/`, `commands/`, `templates/`, `schemas/`, `benchmarks/`: the orchestrated fleet and its artifacts.
